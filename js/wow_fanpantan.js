...
function Howtoplay() {
	...
	str += '<li>กิจกรรมจะเริ่มเก็บสะสม WOW ตั้งแต่วันที่ 1-15 ธ.ค. 64 </li>';
	str += '<li>ภารกิจแฟนพันธุ์แท้ WOW จะมีการแข่งขันเก็บสะสม WOW ทุกวัน ผู้ที่ตอบคำถามได้ถูกต้องรับ WOW สะสมครั้งละ 10 WOW</li>';
	str += '<li>เมื่อผู้แข่งขันเข้าทำการแข่งขันครบ 10 ครั้งรับโบนัส 50 WOW</li>';
	str += '<li>ทุก ๆ WOW ที่สะสมจะถูกจัดอันดับเพื่อหาผู้ที่ทำคะแนนสูงสุด 50 อันดับแรก รับ WOW พิเศษเมื่อจบการแข่งขันอีกตามอันดับการแข่งขัน</li>';
	...
	str += '<li>พนักงาน 1 ท่านรับรางวัลสูงสุดเพียง 1 รางวัลเท่านั้น</li>';
